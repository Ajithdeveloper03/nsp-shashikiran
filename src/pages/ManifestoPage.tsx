...
import shashi5 from '../assets/entrpreunor.jpg';
import shashi6 from '../assets/water.jpg';
import shashi7 from '../assets/clean.jpg';
import shashi8 from '../assets/women-safety1.jpg';
...
const translations = {
  en: {
    ...
    items: [
      ...
      { id: "03", icon: GraduationCap, title: "Job & Skill Development", subtitle: "50 Key Locations", desc: "Establishing 50 Skill Development Centers across the constituency providing hands-on training in high-demand fields like IT, logistics, and creative arts.", img: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg", accent: "#CC0000" },
      ...
      { id: "08", icon: Waves, title: "Flood Protection Tech", subtitle: "Prevention", desc: "Deploying Flood Protection Machines and advanced sensors to monitor river levels. Modern embankment technology will protect our homes and farms.", img: shashi6, accent: "#FF8C00" },
    ...
    roadmap: {
      ...
      points: [
        ...
        { icon: Library, title: "Heritage Education", desc: "Digital Library and Cultural Center to teach the next generation about the history of Srirangam.", img: shashi7 },
        { icon: Truck, title: "Health on Wheels", desc: "Mobile medical units that visit rural areas and outskirts every week for free check-ups.", img: "https://images.pexels.com/photos/263402/pexels-photo-263402.jpeg" }
      ]
    },
              ...
              return (
                <Reveal key={idx} delay={idx * 0.1}>
                  <div className="group relative h-[400px] rounded-[3rem] overflow-hidden bg-white/5 border border-white/10">
                    <img src={point.img} className="absolute inset-0 w-full h-full object-cover opacity-30 grayscale group-hover:grayscale-0 group-hover:opacity-60 transition-all duration-700" />
          ...
          <div className="mt-32 text-center">
            <Reveal delay={0.3}>
              <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                className="bg-[#CC0000] text-white px-16 py-6 rounded-full font-black uppercase tracking-[4px] text-xs shadow-[0_20px_50px_rgba(204,0,0,0.3)] flex items-center justify-center gap-3 mx-auto">
                {t.cta}
                <ArrowRight size={18} />
              </motion.button>
